      ...
      { text: "Payments", style: "subheader" },
      {
        table: {
          ...
          body: [
            ...
            ["Credit cards", `R ${payments?.creditCards?.toString() || "0"}`],
            ["Online EFTs", `R ${payments?.onlineEFTs?.toString() || "0"}`],
            ["Vouchers", `R ${payments?.vouchers?.toString() || "0"}`],
            ["Members", `R ${payments?.members?.toString() || "0"}`],
            ["Agents to invoice", `R ${payments?.agentsToInvoice?.toString() || "0"}`],
            ["Discounts total", `R ${payments?.discountsTotal?.toString() || "0"}`],
          ],
        },
